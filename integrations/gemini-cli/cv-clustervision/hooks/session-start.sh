#!/usr/bin/env bash
# clustervision SessionStart hook for Gemini CLI.
#
...
# so Gemini injects clustervision's view of prior project sessions + fleet activity.
#
...
context="## clustervision — prior context for ${cwd}
...
Use the clustervision MCP tools (recall, project_sessions, search_sessions) to pull
